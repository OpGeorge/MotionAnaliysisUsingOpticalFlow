...
Mat ReturnFlowDense(const string& name, const Mat& gray, const Mat& flow, float minVel, bool showImages);
...
void circleValShowHistogramDir(const string& name, int* hist, const int  hist_cols, const int hist_height, bool showImages, Point maxVal = Point(0,0));
